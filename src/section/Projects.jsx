...
export default function Projects() {
  ...
  const projects = useMemo(
    () => [
      {
        title: "Todo list",
        link: "https://to-do-list-a2cu.vercel.app/",
        bgColor: "#211342",
        image: isMobile ? photo1 : img1,
      },
      {
        title: "URL_Shortener",
        link: "https://url-shortfrontend.vercel.app/",
        bgColor: "#3884d3",
              ...
              <AnimatePresence mode="wait">
                {activeIndex === idx && (
                  <motion.h3
                    ...
                    className={`block text-center text-[clamp(2rem,6vw,5rem)] text-white/95 sm:absolute sm:-top-25 sm:left-[35%] lg:left-[-5%] sm:mb-0
